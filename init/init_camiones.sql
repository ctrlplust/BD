...
=======
--   Crea todo el esquema + datos mínimos
>>>>>>> 50191c5 (Update)
-- =====================================================
...
-- 3) Producto (depende de categoría)
...
-- 4) Ejecutivo (depende de tipo y sucursal)
...
-- 5) Cliente (depende opcional de Ejecutivo)
...
-- 6) Venta (depende de Cliente, Producto, Ejecutivo y Canal)
...
-- 9) Datos iniciales (idempotentes)
INSERT INTO region (nombre, pais)
VALUES ('RM', 'Chile')
...
=======
VALUES (
  '2025-10-01', '2025-10-31', 10, 1000000, 60.00,
  (SELECT id_ejecutivo FROM Ejecutivo WHERE rut='12.345.678-9'),
